...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-purple-300 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-purple-900 mb-8'
		...
		>
			<div className='flex justify-between items-center mb-6'>
				...
				<select
					className='bg-gray-700 text-white rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-black'
